...
var ServerDate = (function(serverNow) {
    ...
    // ms
    ServerDate.getPrecision = function() {
    ...
    Object.defineProperty(ServerDate, "synchronizationIntervalDelay", {
        ...
        set: function(value) {
            ...
            synchronizationInterval = setInterval(ServerDate.synchronize, ServerDate.synchronizationIntervalDelay);
        }
    });
    ...
    Offset.prototype.toString = function() {
        ...
        // reason.
        return this.value + (typeof this.precision != "undefined" ? " +/- " + this.precision : "") + " ms";
    };
    ...
    function setTarget(newTarget) {
        ...
        //evento di aggiornamento dell'orario dal server
        document.dispatchEvent(new Event('synchronizeServerTime'));
    }
            ...
            request.onload = function() {
                ...
                if(this.status == 200) {
                    try {
                        ...
                        console.log("Unable to read the server's response.");
                    }
                }
            };
    ...
    window.addEventListener('pageshow', ServerDate.synchronize);
